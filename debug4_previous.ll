...
L5:  ;
    ...
    %r254 = mul i32 %r243,1400
    %r255 = add i32 %r254,%r21
    %r256 = getelementptr i32, ptr %r2, i32 %r255
    %r258 = mul i32 %r243,1400
    %r259 = add i32 %r258,%r21
    %r260 = getelementptr i32, ptr %r2, i32 %r259
    %r262 = getelementptr i32, ptr %r1, i32 %r21
    %r264 = mul i32 %r243,1400
    %r265 = add i32 %r264,%r21
    %r266 = getelementptr i32, ptr %r2, i32 %r265
    %r268 = mul i32 %r21,1400
    %r269 = add i32 %r268,%r21
    %r270 = getelementptr i32, ptr %r2, i32 %r269
    %r272 = mul i32 %r243,1400
    %r273 = add i32 %r272,%r21
    %r274 = getelementptr i32, ptr %r2, i32 %r273
    br label %L6
L6:  ;
    %r32 = phi ptr [%r274,%L5],[%r275,%L66]
    %r64 = phi ptr [%r270,%L5],[%r271,%L66]
    %r58 = phi ptr [%r266,%L5],[%r267,%L66]
    %r99 = phi ptr [%r262,%L5],[%r263,%L66]
    %r107 = phi ptr [%r260,%L5],[%r261,%L66]
    %r136 = phi ptr [%r256,%L5],[%r257,%L66]
